...
async function verifyAddress(accountId) {
  ...
  const path = (0,utils/* getLedgerAccountPathByWallet */.w6)((0,util_account/* parseAccountId */.cK)(accountId).network, account.byChain.ton);
  await tonTransport.validateAddress(path, {
    bounceable: ledger_constants/* IS_BOUNCEABLE */.mN,
    walletVersion: getInternalWalletVersion(account.byChain.ton.version)
  });
}
...
//# sourceMappingURL=803.a304deb35299cfbda4c7.js.map