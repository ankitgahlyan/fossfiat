...
const APP_VERSION = (/* unused pure expression or super */ null && ("4.1.6"));
...
const IS_EXTENSION = (/* unused pure expression or super */ null && ("" === '1'));
...
const IS_TELEGRAM_APP = (/* unused pure expression or super */ null && ("1" === '1'));
...
const SWAP_CROSSCHAIN_SLUGS = new Set([config_TONCOIN.slug, TON_USDT_MAINNET_SLUG, TRX.slug, TRC20_USDT_MAINNET_SLUG]);
...
const DEFAULT_ENABLED_TOKEN_SLUGS = {
  mainnet: [config_TONCOIN.slug, TON_USDT_MAINNET_SLUG, TRX.slug, TRC20_USDT_MAINNET_SLUG],
  testnet: [config_TONCOIN.slug, TON_USDT_TESTNET_SLUG, TRX.slug, TRC20_USDT_TESTNET_SLUG]
};

// Toncoin, USDT TON, TRX, USDT TRC20
const DEFAULT_ENABLED_TOKEN_COUNT = DEFAULT_ENABLED_TOKEN_SLUGS.mainnet.length;
const PRIORITY_TOKEN_SLUGS = [config_TONCOIN.slug, TON_USDT_MAINNET_SLUG, TRX.slug];
const COMMON_TOKEN = {
  isFromBackend: true,
  priceUsd: 0,
  percentChange24h: 0
...
/******/ })()
;
//# sourceMappingURL=524.0ab069529a787d925a89.js.map